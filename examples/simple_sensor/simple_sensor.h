 ...
 * @brief Simple sensor includes and definitions
 * @version 0.1
 * @date 2025-02-23
 *
...
extern uint8_t g_sensor_hub_pub_key_prefix[];
extern bool g_packet_sent;
...
#define LPP_CHANNEL_NODE_ID 255		   // Node ID for receiver
